...
// Upsert provides a mock function with given fields: i
func (_m *instanceStorage) Upsert(i *internal.Instance) (bool, error) {
	ret := _m.Called(i)

	var r0 bool
	if rf, ok := ret.Get(0).(func(*internal.Instance) bool); ok {
		r0 = rf(i)
	} else {
		r0 = ret.Get(0).(bool)
	}
