...
func (r *ReconcileAddonsConfiguration) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	addon := &v1alpha1.AddonsConfiguration{}
	err := r.Get(ctx, request.NamespacedName, addon)
	if err != nil {
