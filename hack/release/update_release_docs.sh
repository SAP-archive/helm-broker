...
sed -i "" "s#helm-broker/blob/master/docs#helm-broker/blob/${VERSION}/docs#g" docs/README.md
sed -i "" "s#helm-broker/blob/master/docs#helm-broker/blob/${VERSION}/docs#g" README.md
sed -i "" "s/__RELEASE_VERSION__/${VERSION}/g" docs/release/release-template.md
